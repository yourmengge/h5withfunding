...
export class BuyComponent implements DoCheck, OnDestroy {
    ...
    */
    ...
    buy() {
        ...
        } else if (this.appointPrice < parseFloat(this.stockHQ.priceDownlimit)) {
            this.data.ErrorMsg('委托价格不能低于跌停价');
        } else if (this.appointPrice > parseFloat(this.stockHQ.priceUplimit)) {
     ...
     */
    count(type) {
        const firstNum = this.stockCode.substr(0, 1);
        if (!this.data.isNull(this.appointPrice)) {
            ...
            if (type === -1 && this.appointPrice > 0) {
                if (firstNum === '6' || firstNum === '3' || firstNum === '0') {
                    ...
                    this.appointPrice = this.appointPrice - 0.001;
                }
            } else if (type === 1) {
                if (firstNum === '6' || firstNum === '3' || firstNum === '0') {
                    this.appointPrice = this.appointPrice + 0.01;
            ...
            if (firstNum === '6' || firstNum === '3' || firstNum === '0') {
                ...
                this.appointPrice = parseFloat(this.appointPrice.toFixed(3));
            }
